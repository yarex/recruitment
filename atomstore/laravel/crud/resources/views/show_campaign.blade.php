...
@section('content')
   ...
   <div class="container">
       <div class="row">
            ...
            <div class="col-4">{{ $campaign->group->project->name ?? null}}</div>
        </div>
        <div class="row">
            <div class="col-4">Nazwa grupy projektu</div>
            <div class="col-4">{{ $campaign->group->name ?? null}}</div>
        </div>
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-4">{{ $campaign->group->project->website ?? null}}</div>
        </div>
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-4">{{ $campaign->date_start }}</div>
        </div>
        <div class="row">
            <div class="col-6">
                <a href="/projects">
